import {
  Button, Grid, Grow, MenuItem, MenuList, Checkbox, Dialog, DialogActions, DialogContent,
...
const StudyMaterial = () => {
  ...
  const material = [
    {
      name: 'Study Material Link',
      icon: <AttachFileOutlinedIcon sx={{ fontSize: 100, p: 2 }} color="primary" />,
      person: 'Vaibhav Goel',
      link: 'www.google.com',
      path_name: 'React.js',
    },
  ...
  const AddFile = () => {
    return (
      <>
        <Dialog open={file} maxWidth="xs" fullWidth>
          <DialogContent sx={{ p: 0 }}>
            <Box sx={{ display: "flex", alignItems: "center", p: 2 }}>
              <Box sx={{ mr: 'auto' }}>
                <Typography variant="h6">
              ...
              <Box sx={{ ml: 'auto' }}>
                <IconButton size="small" onClick={() => setFile(false)}>
                  <ClearSharpIcon fontSize="small" />
                </IconButton>
              </Box>
            </Box>
                    ...
                    <Paper>
                      <ClickAwayListener onClickAway={handleClose}>
                        ...
                        >
                          ...
                          <MenuItem onClick={(event) => { setFile(true); handleClose(event); }}>
                            <InsertDriveFileOutlinedIcon sx={{ mr: 1 }} color="disabled" /> New File
                          </MenuItem>
                        </MenuList>
                      </ClickAwayListener>
                    </Paper>
